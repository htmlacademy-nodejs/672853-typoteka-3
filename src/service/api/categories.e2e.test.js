...
describe(`API returns category list`, () => {
  ...
  test(`Category names are "Кино", "Программирование", "Железо", "Мышки", "IT", "Музыка", "Пупсики"`,
      () => expect(response.body).toEqual(
          expect.arrayContaining([`Кино`, `Программирование`, `Железо`, `Мышки`, `IT`, `Музыка`, `Пупсики`])
      )
  );
